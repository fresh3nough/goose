...
export type { AddConfigExtensionRequest, AddExtensionRequest, ArchiveSessionRequest, ChangedFile, CheckSecretRequest, CheckSecretResponse, CreatedWorktree, CreateSourceRequest, CreateSourceResponse, DeleteSessionRequest, DeleteSourceRequest, DictationConfigRequest, DictationConfigResponse, DictationDownloadProgress, DictationLocalModelStatus, DictationModelCancelRequest, DictationModelDeleteRequest, DictationModelDownloadProgressRequest, DictationModelDownloadProgressResponse, DictationModelDownloadRequest, DictationModelOption, DictationModelSelectRequest, DictationModelsListRequest, DictationModelsListResponse, DictationProviderStatusEntry, DictationTranscribeRequest, DictationTranscribeResponse, EmptyResponse, ExportSessionRequest, ExportSessionResponse, ExportSourceRequest, ExportSourceResponse, ExtRequest, ExtResponse, GetExtensionsRequest, GetExtensionsResponse, GetSessionExtensionsRequest, GetSessionExtensionsResponse, GetToolsRequest, GetToolsResponse, GitChangedFilesRequest, GitChangedFilesResponse, GitCreateBranchRequest, GitCreateWorktreeRequest, GitCreateWorktreeResponse, GitFetchRequest, GitInitRequest, GitPullRequest, GitStashRequest, GitState, GitStateRequest, GitStateResponse, GitSwitchBranchRequest, ImportSessionRequest, ImportSessionResponse, ImportSourcesRequest, ImportSourcesResponse, ListProvidersRequest, ListProvidersResponse, ListSourcesRequest, ListSourcesResponse, ProviderConfigKey, ProviderInventoryEntryDto, ProviderInventoryModelDto, ReadConfigRequest, ReadConfigResponse, ReadResourceRequest, ReadResourceResponse, RefreshProviderInventoryRequest, RefreshProviderInventoryResponse, RefreshProviderInventorySkipDto, RefreshProviderInventorySkipReasonDto, RemoveConfigExtensionRequest, RemoveConfigRequest, RemoveExtensionRequest, RemoveSecretRequest, RenameSessionRequest, SourceEntry, SourceType, ToggleConfigExtensionRequest, UnarchiveSessionRequest, UpdateSessionProjectRequest, UpdateSourceRequest, UpdateSourceResponse, UpdateWorkingDirRequest, UpsertConfigRequest, UpsertSecretRequest, WorktreeInfo } from './types.gen.js';
...
export const GOOSE_EXT_METHODS = [
  ...
  {
    method: "_goose/git/state",
    requestType: "GitStateRequest",
    responseType: "GitStateResponse",
  },
  {
    method: "_goose/git/changed_files",
    requestType: "GitChangedFilesRequest",
    responseType: "GitChangedFilesResponse",
  },
  {
    method: "_goose/git/switch_branch",
    requestType: "GitSwitchBranchRequest",
    responseType: "EmptyResponse",
  },
  {
    method: "_goose/git/stash",
    requestType: "GitStashRequest",
    responseType: "EmptyResponse",
  },
  {
    method: "_goose/git/init",
    requestType: "GitInitRequest",
    responseType: "EmptyResponse",
  },
  {
    method: "_goose/git/fetch",
    requestType: "GitFetchRequest",
    responseType: "EmptyResponse",
  },
  {
    method: "_goose/git/pull",
    requestType: "GitPullRequest",
    responseType: "EmptyResponse",
  },
  {
    method: "_goose/git/create_branch",
    requestType: "GitCreateBranchRequest",
    responseType: "EmptyResponse",
  },
  {
    method: "_goose/git/create_worktree",
    requestType: "GitCreateWorktreeRequest",
    responseType: "GitCreateWorktreeResponse",
  },
  {
